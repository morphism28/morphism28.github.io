...
<title>best_practices – Morphism28's Homepage</title>
<style>
...
<link href="../../../../../../site_libs/bootstrap/bootstrap-1a132d930027b5fd74a256d1893ae507.min.css" rel="stylesheet" append-hash="true" id="quarto-bootstrap" data-mode="light">
...
<div id="quarto-search-results"></div>
  <header id="quarto-header" class="headroom fixed-top">
    ...
    <span class="navbar-title">Morphism28’s Homepage</span>
    </a>
  </div>
  ...
  window.document.addEventListener("DOMContentLoaded", function (event) {
    ...
    if (window.document.getElementById('quarto-embedded-source-code-modal')) {
      ...
      var mailtoRegex = new RegExp(/^mailto:/);
        var filterRegex = new RegExp("https:\/\/morphism28\.github\.io");
      var isInternal = (href) => {
